input/state_results/.sentinel:
	...
	curl http://data.cnn.com/ELECTION/2016primary/AK/county/E.json -o input/state_results/alaska_democrat.json
	...
	curl http://data.cnn.com/ELECTION/2016primary/CA/county/R.json -o input/state_results/california_republican.json
	curl http://data.cnn.com/ELECTION/2016primary/CA/county/D.json -o input/state_results/california_democrat.json
	curl http://data.cnn.com/ELECTION/2016primary/CO/county/E.json -o input/state_results/colorado_democrat.json
	curl http://data.cnn.com/ELECTION/2016primary/CT/county/R.json -o input/state_results/connecticut_republican.json
	curl http://data.cnn.com/ELECTION/2016primary/CT/county/D.json -o input/state_results/connecticut_democrat.json
	curl http://data.cnn.com/ELECTION/2016primary/DE/county/R.json -o input/state_results/delaware_republican.json
	curl http://data.cnn.com/ELECTION/2016primary/DE/county/D.json -o input/state_results/delaware_democrat.json
	...
	curl http://data.cnn.com/ELECTION/2016primary/HI/county/E.json -o input/state_results/hawaii_democrat.json
	...
	curl http://data.cnn.com/ELECTION/2016primary/IN/county/R.json -o input/state_results/indiana_republican.json
	curl http://data.cnn.com/ELECTION/2016primary/IN/county/D.json -o input/state_results/indiana_democrat.json
	...
	curl http://data.cnn.com/ELECTION/2016primary/KY/county/D.json -o input/state_results/kentucky_democrat.json
	...
	curl http://data.cnn.com/ELECTION/2016primary/MD/county/R.json -o input/state_results/maryland_republican.json
	curl http://data.cnn.com/ELECTION/2016primary/MD/county/D.json -o input/state_results/maryland_democrat.json
	...
	curl http://data.cnn.com/ELECTION/2016primary/MT/county/R.json -o input/state_results/montana_republican.json
	curl http://data.cnn.com/ELECTION/2016primary/MT/county/D.json -o input/state_results/montana_democrat.json
	curl http://data.cnn.com/ELECTION/2016primary/NE/county/R.json -o input/state_results/nebraska_republican.json
	...
	curl http://data.cnn.com/ELECTION/2016primary/NJ/county/R.json -o input/state_results/new_jersey_republican.json
	curl http://data.cnn.com/ELECTION/2016primary/NJ/county/D.json -o input/state_results/new_jersey_democrat.json
	curl http://data.cnn.com/ELECTION/2016primary/NM/county/R.json -o input/state_results/new_mexico_republican.json
	curl http://data.cnn.com/ELECTION/2016primary/NM/county/D.json -o input/state_results/new_mexico_democrat.json
	curl http://data.cnn.com/ELECTION/2016primary/NY/county/R.json -o input/state_results/new_york_republican.json
	curl http://data.cnn.com/ELECTION/2016primary/NY/county/D.json -o input/state_results/new_york_democrat.json
	...
	curl http://data.cnn.com/ELECTION/2016primary/ND/county/E.json -o input/state_results/north_dakota_democrat.json
	...
	curl http://data.cnn.com/ELECTION/2016primary/OR/county/R.json -o input/state_results/oregon_republican.json
	curl http://data.cnn.com/ELECTION/2016primary/OR/county/D.json -o input/state_results/oregon_democrat.json
	curl http://data.cnn.com/ELECTION/2016primary/PA/county/R.json -o input/state_results/pennsylvania_republican.json
	curl http://data.cnn.com/ELECTION/2016primary/PA/county/D.json -o input/state_results/pennsylvania_democrat.json
	curl http://data.cnn.com/ELECTION/2016primary/RI/county/R.json -o input/state_results/rhode_island_republican.json
	curl http://data.cnn.com/ELECTION/2016primary/RI/county/D.json -o input/state_results/rhode_island_democrat.json
	...
	curl http://data.cnn.com/ELECTION/2016primary/SD/county/R.json -o input/state_results/south_dakota_republican.json
	curl http://data.cnn.com/ELECTION/2016primary/SD/county/D.json -o input/state_results/south_dakota_democrat.json
	...
	curl http://data.cnn.com/ELECTION/2016primary/WA/county/R.json -o input/state_results/washington_republican.json
	curl http://data.cnn.com/ELECTION/2016primary/WA/county/E.json -o input/state_results/washington_democrat.json
	curl http://data.cnn.com/ELECTION/2016primary/WV/county/R.json -o input/state_results/west_virginia_republican.json
	curl http://data.cnn.com/ELECTION/2016primary/WV/county/D.json -o input/state_results/west_virginia_democrat.json
	curl http://data.cnn.com/ELECTION/2016primary/WI/county/R.json -o input/state_results/wisconsin_republican.json
	curl http://data.cnn.com/ELECTION/2016primary/WI/county/D.json -o input/state_results/wisconsin_democrat.json
	curl http://data.cnn.com/ELECTION/2016primary/WY/county/S.json -o input/state_results/wyoming_republican.json
	curl http://data.cnn.com/ELECTION/2016primary/WY/county/E.json -o input/state_results/wyoming_democrat.json
...
output/primary_results.csv: input/state_results/.sentinel
	mkdir -p output
	bpython src/primary_results.py
...
output/county_facts.csv: input/county_facts_saved/county_facts.csv
	cp input/county_facts_saved/county_facts.csv output/county_facts.csv
output/county_facts_dictionary.csv: input/county_facts_saved/county_facts_dictionary.csv
	cp input/county_facts_saved/county_facts_dictionary.csv output/county_facts_dictionary.csv
